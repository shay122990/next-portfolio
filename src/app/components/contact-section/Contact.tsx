...
export default function Contact() {
  return (
    <section className="w-full lg:px-10 px-4 mb-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 justify-center items-center min-h-[600px] bg-gradient-to-br from-white to-gray-200 dark:from-[#111] dark:to-[#333] bg-opacity-40 rounded-lg gap-4 py-10 px-5">
