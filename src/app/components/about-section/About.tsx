      ...
      <article className="relative z-10 w-full flex flex-col lg:flex-row items-center lg:items-stretch lg:gap-20 px-6 lg:px-16 py-4">
        <div className="flex flex-row lg:flex-col justify-center items-center gap-4">
          {iconList.map((Icon, i) => (
            <div
              key={i}
              className={`text-4xl w-20 h-20 flex items-center justify-center rotate-${
                [-6, 5, -3, 4][i]
        ...
        <div className="flex-1 flex justify-center">
          <div className="space-y-8  lg:text-xl lg:w-3/4  font-light leading-relaxed text-gray-900 dark:text-gray-200 drop-shadow-sm dark:drop-shadow-[0_0_5px_rgba(0,255,255,0.2)]">
            <p>
              ...
              , and I care a lot about performance, accessibility, and good UI.
            </p>

            <p>
              I’ve built e-commerce platforms, landing pages, dashboards, and
              more — always focusing on structure, reusability, and smooth user
              experience.
            </p>

            <p>
              I like working closely with designers, solving layout challenges,
              and writing code that actually makes sense six months later.
            </p>

            <p>
              Whether you need a full front-end build, help on a team, or
              someone to clean up what’s already there — I can help.
            </p>
          </div>
        </div>
      </article>
